...
{
    /**
     * All application tables that need soft-delete columns.
     * Laravel system tables (migrations, cache, jobs, sessions, etc.) and
     * Spatie media are intentionally excluded.
     */
