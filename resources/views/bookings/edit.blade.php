...
@section('title', __('bookings.edit_booking'))
    ...
    <div class="bg-white rounded-2xl shadow-lg border border-gray-100">
        ...
        <div class="px-6 py-5 border-b border-gray-100 bg-gradient-to-r from-blue-50 to-white rounded-t-2xl">
            <div class="flex items-center justify-between">
                <div>
                    <h2 class="text-xl font-extrabold text-secondary">{{ __('bookings.edit_booking') }}</h2>
        ...
        <form method="POST" action="{{ route('bookings.update', $booking) }}" class="p-6" x-data="editBookingForm()">
            ...
            <div class="space-y-8">
                ...
                <div>
                    ...
                    <div>
                        <label class="block text-sm font-semibold text-secondary mb-2">{{ __('bookings.form.change_guest_optional') }}</label>
                        <select name="guest_id" class="w-full px-4 py-3 rounded-xl border border-gray-200 focus:ring-2 focus:ring-primary focus:border-primary transition-all">
                            <option value="">{{ __('bookings.form.keep_current_guest') }}</option>
                ...
                <div>
                    ...
                    <!-- Room Selection -->
                    <div>
                        <label class="block text-sm font-semibold text-secondary mb-2">{{ __('bookings.fields.room') }} <span class="text-red-500">*</span></label>
                                    ...
                                    <div class="flex-1">
                                        ...
                                        <div class="text-xs text-gray-500 mt-1">
                                            ...
                                            @if($room->id == $booking->room_id)
                                                <span class="text-primary font-semibold">({{ __('bookings.current') }})</span>
                                            @endif
                                        </div>
                                    </div>
                                </label>
                ...
                <div>
                    ...
                    <div>
                        ...
                        <textarea name="special_requests" rows="3"
                                  class="w-full px-4 py-3 rounded-xl border border-gray-200 focus:ring-2 focus:ring-primary focus:border-primary transition-all"
                                  placeholder="{{ __('bookings.form.special_requests_placeholder') }}">{{ old('special_requests', $booking->special_requests) }}</textarea>
                    </div>
                </div>
