        ...
        <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden mb-8">
                ...
                <div class="bg-gradient-to-r from-primary to-blue-600 p-6 text-center">
                    <p class="text-white/80 font-semibold tracking-widest uppercase text-sm mb-1">Reservation Number</p>
                    <h2 class="text-3xl font-bold text-white tracking-wider">{{ $reservation->reservation_number }}</h2>
                </div>
                        ...
                        <div>
                            ...
                            <div class="space-y-3">
                                ...
                                <div>
                                    ...
                                    <p class="font-semibold text-secondary">{{ $reservation->guest_country }}</p>
                                </div>
                                @endif
                            </div>
                        </div>
                            ...
                            <div class="space-y-3">
                                <div class="flex justify-between">
                                    <div>
                                        ...
                                        <p class="font-semibold text-secondary">{{ $reservation->check_in_date->format('D, M d, Y') }}</p>
                                        <p class="text-sm text-gray-500">After 3:00 PM</p>
                                    </div>
                                    <div class="text-right">
                                        <span class="text-gray-500 text-sm">Check-out</span>
                                        <p class="font-semibold text-secondary">{{ $reservation->check_out_date->format('D, M d, Y') }}</p>
                                        <p class="text-sm text-gray-500">Before 11:00 AM</p>
                                    </div>
                                </div>
                                <div>
                                    <span class="text-gray-500 text-sm">Guests</span>
                                    <p class="font-semibold text-secondary">{{ $reservation->number_of_guests }} {{ $reservation->number_of_guests > 1 ? 'Guests' : 'Guest' }}</p>
                                </div>
                            </div>
                        </div>
                    </div>
