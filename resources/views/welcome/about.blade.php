...
<main class="overflow-hidden">
    ...
    <section class="relative py-24 md:py-32">
        ...
        <div class="container mx-auto px-6 lg:px-8 relative z-10">
            <div class="max-w-3xl">
                <span class="inline-flex items-center gap-2 px-4 py-2 bg-white/20 text-white text-sm font-semibold rounded-full mb-6 backdrop-blur-sm">Our Story</span>
    ...
    <section class="py-20 bg-white">
        <div class="container mx-auto px-6 lg:px-8">
            <div class="grid lg:grid-cols-2 gap-16 items-center">
                <div>
                    <span class="inline-block px-4 py-2 bg-primary/10 text-primary text-sm font-semibold rounded-full mb-4">Our Heritage</span>
        ...
        <div class="container mx-auto px-6 lg:px-8">
            ...
            <div class="grid grid-cols-2 lg:grid-cols-4 gap-8">
                <div class="text-center p-8 bg-gray-50 rounded-2xl">
                    <div class="text-4xl md:text-5xl font-extrabold text-primary mb-2">150+</div>
                    <div class="text-gray-600 font-medium">Elegant Rooms</div>
                </div>
                <div class="text-center p-8 bg-gray-50 rounded-2xl">
                    <div class="text-4xl md:text-5xl font-extrabold text-primary mb-2">22</div>
                    <div class="text-gray-600 font-medium">Years of Service</div>
                </div>
                <div class="text-center p-8 bg-gray-50 rounded-2xl">
                    <div class="text-4xl md:text-5xl font-extrabold text-primary mb-2">4.8</div>
                    <div class="text-gray-600 font-medium">Guest Rating</div>
                </div>
                <div class="text-center p-8 bg-gray-50 rounded-2xl">
                    <div class="text-4xl md:text-5xl font-extrabold text-primary mb-2">50K+</div>
    ...
    <section class="py-20 bg-gray-50">
        <div class="container mx-auto px-6 lg:px-8">
            <div class="text-center max-w-3xl mx-auto mb-16">
                <span class="inline-block px-4 py-2 bg-primary/10 text-primary text-sm font-semibold rounded-full mb-4">Our Leadership</span>
                <h2 class="text-3xl md:text-4xl font-extrabold text-secondary mb-6">
            ...
            <div class="grid md:grid-cols-3 gap-8">
                <div class="bg-white rounded-2xl overflow-hidden shadow-lg">
                    ...
                    <div class="p-6 text-center">
                        ...
                        <p class="text-primary font-medium mb-3">General Manager</p>
                ...
                <div class="bg-white rounded-2xl overflow-hidden shadow-lg">
                    ...
                    <div class="p-6 text-center">
                        ...
                        <p class="text-primary font-medium mb-3">Director of Operations</p>
                ...
                <div class="bg-white rounded-2xl overflow-hidden shadow-lg">
                    ...
                    <div class="p-6 text-center">
                        <h3 class="text-xl font-bold text-secondary">Chef David Odhiambo</h3>
                        <p class="text-primary font-medium mb-3">Executive Chef</p>
    ...
    <section class="py-20 bg-white">
        <div class="container mx-auto px-6 lg:px-8">
            <div class="text-center max-w-3xl mx-auto mb-16">
                <span class="inline-block px-4 py-2 bg-primary/10 text-primary text-sm font-semibold rounded-full mb-4">Our Values</span>
                <h2 class="text-3xl md:text-4xl font-extrabold text-secondary mb-6">
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
                <div class="text-center">
                    <div class="bg-gradient-to-br from-primary to-blue-600 h-16 w-16 rounded-full flex items-center justify-center mb-5 mx-auto shadow-lg">
                        <svg class="h-8 w-8 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z" />
                        </svg>
                    </div>
                    <h3 class="text-lg font-bold text-secondary mb-2">Warmth</h3>
                ...
                <div class="text-center">
                    ...
                    <h3 class="text-lg font-bold text-secondary mb-2">Excellence</h3>
                ...
                <div class="text-center">
                    ...
                    <h3 class="text-lg font-bold text-secondary mb-2">Sustainability</h3>
                ...
                <div class="text-center">
                    ...
                    <h3 class="text-lg font-bold text-secondary mb-2">Integrity</h3>
        ...
        <div class="container mx-auto px-6 lg:px-8 text-center">
            <div class="max-w-4xl mx-auto">
                ...
                <div class="flex flex-col sm:flex-row gap-4 justify-center">
                    <a href="{{ url('/contact') }}" class="inline-flex items-center justify-center px-8 py-4 text-base font-semibold rounded-xl bg-white text-primary shadow-lg hover:shadow-xl transition-shadow">
                        Contact Us
                        <svg class="ml-2 h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 7l5 5m0 0l-5 5m5-5H6" />
                        </svg>
                    </a>
                    <a href="{{ url('/contact') }}" class="inline-flex items-center justify-center px-8 py-4 text-base font-semibold rounded-xl border-2 border-white text-white hover:bg-white/10 transition-colors">
                        Contact Us
                    </a>
                </div>
            </div>
