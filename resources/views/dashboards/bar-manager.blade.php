{{-- resources/views/dashboards/bar-manager.blade.php --}}
@extends('layouts.app')

@section('title', 'Bar Manager Dashboard - MRK Hotel')
@section('page-title', 'Bar Manager Dashboard')
...
<div class="bg-gradient-to-r from-amber-500 to-orange-600 rounded-2xl p-6 mb-8 text-white shadow-xl">
    <div class="flex items-center justify-between">
        <div>
            ...
            <p class="text-amber-100">Bar inventory overview for today.</p>
        </div>
    ...
    <div class="bg-white rounded-2xl shadow-lg border border-gray-100 p-6">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-3xl font-extrabold text-secondary mt-1">{{ $stats['total_bar_products'] }}</p>
            </div>
...
<div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
    ...
    <div class="lg:col-span-2 bg-white rounded-2xl shadow-lg border border-gray-100 p-6">
        <div class="flex justify-between items-center mb-4">
            <h3 class="text-lg font-extrabold text-secondary">Recent Bar Movements</h3>
    ...
    <div class="bg-white rounded-2xl shadow-lg border border-gray-100 p-6">
        ...
        <div class="space-y-3">
            ...
            <a href="{{ $note->action_url ?? '#' }}" class="block p-3 bg-blue-50 rounded-xl hover:bg-blue-100 transition">
...
<div class="mt-6 grid grid-cols-1 md:grid-cols-3 gap-4">
    <a href="{{ route('store.transfers.create') }}" class="bg-white rounded-2xl shadow-lg border border-gray-100 p-6 hover:shadow-xl transition group">
        <div class="flex items-center gap-4">
            <div class="w-12 h-12 bg-gradient-to-br from-amber-50 to-amber-100 rounded-xl flex items-center justify-center group-hover:scale-110 transition">
    ...
    <a href="{{ route('store.stock.levels') }}" class="bg-white rounded-2xl shadow-lg border border-gray-100 p-6 hover:shadow-xl transition group">
        <div class="flex items-center gap-4">
            ...
            <div>
                ...
                <p class="text-xs text-gray-500">Check bar inventory levels</p>
            </div>
        </div>
    </a>
    <a href="{{ route('store.reports.damage') }}" class="bg-white rounded-2xl shadow-lg border border-gray-100 p-6 hover:shadow-xl transition group">
        <div class="flex items-center gap-4">
            ...
            <div>
                <p class="font-bold text-secondary">Damage Report</p>
                <p class="text-xs text-gray-500">View damage history</p>
            </div>
        </div>
    </a>
</div>
