    ...
    <div class="bg-white rounded-2xl shadow-lg border border-gray-100 p-6 hover:shadow-xl transition-shadow">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-xs text-blue-600 font-medium mt-1">Active staff members</p>
            </div>
    ...
    <div class="bg-white rounded-2xl shadow-lg border border-gray-100 p-6 hover:shadow-xl transition-shadow">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-xs text-orange-600 font-medium mt-1">Categories configured</p>
            </div>
...
<div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
    ...
    <!-- Users by Role -->
    <div class="bg-white rounded-2xl shadow-lg border border-gray-100 p-6">
        <h3 class="text-lg font-extrabold text-secondary mb-6">Staff by Role</h3>
        @php
...
<div class="bg-white rounded-2xl shadow-lg border border-gray-100 p-6 mb-8">
    <div class="flex items-center justify-between mb-6">
        <h3 class="text-lg font-extrabold text-secondary">Recent Users</h3>
...
<div class="bg-white rounded-2xl shadow-lg border border-gray-100 p-6">
    ...
    <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
        ...
        <a href="{{ route('floors.create') }}" class="flex flex-col items-center p-6 bg-gradient-to-br from-green-50 to-green-100 rounded-xl hover:shadow-lg transition border border-green-200 group">
            ...
            <span class="text-sm font-semibold text-secondary">Add Floor</span>
        </a>
