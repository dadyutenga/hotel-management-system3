...
<footer class="bg-gray-900 text-white">
    <div class="container mx-auto px-6 lg:px-8 py-16">
        <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-12">
            ...
            <div>
                <h4 class="text-white font-semibold mb-6">Hotel Information</h4>
                <ul class="space-y-3">
                    <li><a href="{{ url('/about') }}" class="text-gray-400 hover:text-white text-sm transition-colors">About Us</a></li>
                    <li><a href="{{ url('/gallery') }}" class="text-gray-400 hover:text-white text-sm transition-colors">Photo Gallery</a></li>
                    <li><a href="{{ url('/careers') }}" class="text-gray-400 hover:text-white text-sm transition-colors">Careers</a></li>
                    <li><a href="{{ url('/contact') }}" class="text-gray-400 hover:text-white text-sm transition-colors">Contact Us</a></li>
                </ul>
            </div>
            
            <!-- Contact Column -->
            <div>
                <h4 class="text-white font-semibold mb-6">Contact Information</h4>
                <ul class="space-y-4">
                    <li class="flex items-start gap-3">
                        ...
                        <span class="text-gray-400 text-sm">Samora Avenue<br>Dar es Salaam, Tanzania</span>
                    </li>
        ...
        <div class="border-t border-gray-800 mt-12 pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <div class="flex items-center gap-6">
                ...
                <a href="{{ url('/sitemap') }}" class="text-gray-400 hover:text-white text-sm transition-colors">Sitemap</a>
            </div>
        </div>
    </div>
</footer>
