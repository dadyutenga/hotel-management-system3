...
<div class="max-w-6xl mx-auto space-y-6">
    ...
    <div class="flex items-center justify-between">
        ...
        <div class="flex items-center gap-3">
            ...
            <!-- Print Button -->
            <button type="button"
                onclick="document.getElementById('print-modal').classList.remove('hidden'); document.getElementById('print-frame').src = '{{ route('procurement.grn.print', $goodsReceivedNote) }}'"
...
<div id="print-modal" class="hidden fixed inset-0 bg-black bg-opacity-60 flex items-center justify-center z-50 no-print">
    <div class="bg-white rounded-2xl shadow-2xl w-full max-w-5xl mx-4 h-[90vh] flex flex-col">
        <div class="flex items-center justify-between px-6 py-4 border-b border-gray-200">
            <h3 class="text-lg font-bold text-secondary">Print Preview — {{ $goodsReceivedNote->grn_number }}</h3>
            <div class="flex items-center gap-3">
                <button type="button"
