...
<div class="max-w-2xl mx-auto">
    <div class="bg-white rounded-xl shadow-sm border border-gray-200">
        ...
        <div class="px-6 py-4 border-b border-gray-200">
            <h2 class="text-xl font-semibold text-gray-900">Edit Room</h2>
                ...
                <div class="bg-gray-50 rounded-lg p-4 border border-gray-200">
                    ...
                    <div class="grid grid-cols-2 gap-4 text-sm">
                        <div>
                            ...
                            <span class="text-gray-900 font-medium ml-2">{{ $room->floor->building->name }} - {{ $room->floor->name }}</span>
                        </div>
                        <div>
                            <span class="text-gray-500">Type:</span>
                            <span class="text-gray-900 font-medium ml-2">{{ $room->roomType->name }}</span>
                        </div>
                        <div>
                            <span class="text-gray-500">Base Rate:</span>
                            <span class="text-gray-900 font-medium ml-2">${{ number_format($room->roomType->base_rate, 2) }}</span>
                        </div>
                        <div>
                            <span class="text-gray-500">Created:</span>
                            <span class="text-gray-900 font-medium ml-2">{{ $room->created_at->format('M d, Y') }}</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
                    <div class="flex gap-3">
                        ...
                        <div class="text-sm text-yellow-800">
                            <p class="font-medium">Room is currently {{ $room->status }}</p>
                            <p class="mt-1">Please ensure there are no active reservations before changing the status.</p>
                        </div>
                    </div>
                </div>
                @endif
