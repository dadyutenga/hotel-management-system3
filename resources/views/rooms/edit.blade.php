            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <select 
                        ...
                        <option value="{{ $roomType->id }}" {{ old('room_type_id', $room->room_type_id) == $roomType->id ? 'selected' : '' }}>
                            {{ $roomType->name }} ({{ $roomType->code }}) - {{ $roomType->formatted_rate }}
                        </option>
                        @endforeach
                    </select>
                    @error('room_type_id')
                ...
                <div>
                    ...
                    <select 
                        ...
                        <option value="needs_cleaning" {{ old('status', $room->status) == 'needs_cleaning' ? 'selected' : '' }}>{{ __('rooms.status.needs_cleaning') }}</option>
                ...
                <div class="bg-gradient-to-br from-blue-50 to-white rounded-xl p-4 border border-blue-100">
                    ...
                    <div class="grid grid-cols-2 gap-4 text-sm">
                        ...
                        <div>
                            ...
                            <span class="text-secondary font-semibold ml-2">{{ $room->roomType->formatted_rate }}</span>
                        </div>
                        <div>
