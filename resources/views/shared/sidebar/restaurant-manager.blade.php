...
<nav class="flex-1 px-3 py-4 space-y-1 overflow-y-auto">
    ...
    <div class="pt-4">
        <p class="px-3 text-xs font-semibold text-gray-400 uppercase tracking-wider mb-2">Bar & Restaurant</p>
    ...
    <div class="pt-4">
        <p class="px-3 text-xs font-semibold text-gray-400 uppercase tracking-wider mb-2">Stock</p>
