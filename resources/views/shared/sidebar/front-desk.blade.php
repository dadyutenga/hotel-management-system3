...
<nav class="flex-1 overflow-y-auto py-4 px-3">
    ...
    <a href="#" class="flex items-center gap-3 px-3 py-2.5 rounded-xl mb-1 text-gray-700 hover:bg-blue-50 hover:text-primary transition-all">
        ...
        <span class="ml-auto text-[10px] bg-primary/10 text-primary px-2 py-0.5 rounded-full font-semibold">{{ __('general.loading') }}</span>
    </a>
    ...
    <div class="mt-6 mb-2">
        <div class="px-3 text-xs font-bold text-primary uppercase tracking-wider">{{ __('dashboard.help') }}</div>
    </div>
    ...
    <a href="#" class="flex items-center gap-3 px-3 py-2.5 rounded-xl mb-1 text-gray-700 hover:bg-blue-50 hover:text-primary transition-all">
        ...
        <span class="font-medium">{{ __('dashboard.help_support') }}</span>
    </a>
</nav>
