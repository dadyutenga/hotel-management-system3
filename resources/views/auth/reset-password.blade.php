...
<head>
    ...
    <title>{{ __('auth.reset.reset_password') }} - Hotel Management System</title>
    <link rel="icon" type="image/png" href="{{ asset('images/header.png') }}">
    <meta name="description" content="Set a new password for your hotel management system staff account.">
