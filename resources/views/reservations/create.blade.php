...
<div class="max-w-3xl mx-auto">
    <div class="bg-white rounded-xl shadow-sm border border-gray-200">
        ...
        <div class="px-6 py-4 border-b border-gray-200">
            <h2 class="text-xl font-semibold text-gray-900">Create Reservation</h2>
                ...
                <div>
                    ...
                    <div class="mt-6">
                        <label for="room_id" class="block text-sm font-medium text-gray-700 mb-2">
                            Assign Room <span class="text-gray-400 text-xs">(Optional - can be assigned later)</span>
                        </label>
                        <select 
                            name="room_id" 
                            id="room_id"
                ...
                <div class="bg-blue-50 border border-blue-200 rounded-lg p-4">
                    <div class="flex gap-3">
                        ...
                        <div class="text-sm text-blue-800">
                            <p class="font-medium mb-1">Reservation Tips:</p>
