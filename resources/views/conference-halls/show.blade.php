...
<div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
        <div>
            ...
            <p class="text-sm text-gray-500 mt-1">{{ $conferenceHall->location }}</p>
        </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div class="md:col-span-2 bg-white rounded-2xl shadow-lg border border-gray-100 p-6">
            ...
            <h3 class="text-lg font-bold text-secondary mt-6 mb-4">Location</h3>
            <p class="text-gray-600">{{ $conferenceHall->location }}</p>
        </div>
