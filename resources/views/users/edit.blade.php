                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input 
                                ...
                                name="password" 
                                id="password"
                                class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors @error('password') border-red-500 @enderror"
                                placeholder="••••••••">
                            @error('password')
                                <p class="mt-1.5 text-sm text-red-600 flex items-center gap-1">
                                    <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                ...
                <div>
                    ...
                    <div class="mb-6">
                        ...
                        <select 
                            name="role_id" 
                            id="role_id"
                            class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors @error('role_id') border-red-500 @enderror"
                            required>
                ...
                <div class="bg-gray-50 rounded-lg p-4 border border-gray-200">
                    ...
                    <div class="grid grid-cols-2 gap-4 text-sm">
                        <div>
                            ...
                            <span class="text-gray-900 font-medium ml-2">{{ $user->role->display_name }}</span>
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <span class="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium ml-2 {{ $user->is_active ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800' }}">
                                {{ $user->is_active ? 'Active' : 'Inactive' }}
                            </span>
                        </div>
                    </div>
                ...
                <div class="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
                    <div class="flex gap-3">
                        ...
                        <div class="text-sm text-yellow-800">
                            <p class="font-medium">You are editing your own account</p>
                            <p class="mt-1">Be careful when changing your role or deactivating your account as this may affect your access to the system.</p>
                        </div>
                    </div>
                </div>
                @endif
