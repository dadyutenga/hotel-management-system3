...
class Reservation extends Model
{
    ...
    protected $fillable = [
        'reservation_number', 'room_id', 'building_id', 'guest_id', 'booking_id', 'guest_name', 'guest_phone', 'guest_email',
    ...
    {
        return $this->status === self::STATUS_CONFIRMED && $this->room_id !== null;
    }
