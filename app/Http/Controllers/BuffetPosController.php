...
class BuffetPosController extends Controller
{
    public function index(): View
    {
        ...
        $sessions = BuffetPackage::forBuilding($buildingId)
    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        BuildingContext::enforce($session->building_id);
        ...
        $sale = DB::transaction(function () use ($data, $session, $adults, $children, $total, $isChargeToBooking, $buildingId) {
